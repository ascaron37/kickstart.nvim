...
vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float, { desc = 'Open diagnostic float window [e]' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = {
      ...
      prompts = {
        Rename = {
          prompt = 'Rename the variable correctly in given selection based context',
    ...
    keys = {
      { '<leader>cn', ':CopilotChatRename<CR>', mode = 'v', desc = '[C]opilot [R]ename' },
      ...
      { '<leader>cd', ':CopilotChatDocs<CR>', mode = 'v', desc = '[C]opilot [D]ocs' },
      { '<leader>ct', ':CopilotChatTests<CR>', mode = 'v', desc = '[C]opilot [T]ests' },
      { '<leader>cm', ':CopilotChatCommit<CR>', mode = 'n', desc = '[C]opilot [C]ommit message' },
    },
